...
Theme::asset()->add('bootstrap-plugin-css', 'theme/css/bootstrap-plugin.css');
Theme::asset()->add('ionicons-css', 'theme/css/ionicons.min.css');
Theme::asset()->add('qtip-css', 'theme/css/jquery.qtip.min.css');
Theme::asset()->add('colorbox-css', 'theme/css/colorbox.css');
